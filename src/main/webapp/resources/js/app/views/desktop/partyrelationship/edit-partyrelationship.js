define([
    ...
    'text!../../../../../templates/desktop/partyrole/partyrole-list-subview.html',
    'text!../../../../../templates/desktop/partyrelationshiptype/partyrelationshiptype-list-subview.html',
    'text!../../../../../templates/desktop/partyrelationship/edit-partyrelationship.html'
], function (utilities, config, formUtilities, entities_strings, PartyRoles, PartyRelationshipTypes, partyRoleListSubViewTemplate, partyRelationshipTypeListSubViewTemplate, PartyRelationshipEditTemplate) {
    ...
    var PartyRoleListSubView = Backbone.View.extend({
        ...
        {     
            var self = this;            
            utilities.applyTemplate($('#partyRoleSelectContainerDiv'), partyRoleListSubViewTemplate,  {model:self.model, relatedFieldName:"partyRole", entities_strings:entities_strings, selectedOption:this.options.selectedOption});
            // Fetch data
            var partyRolesFetch = this.model.fetch();
            // Re render the template when the data is available    
            partyRolesFetch.done(function (){
                utilities.applyTemplate($('#partyRoleSelectContainerDiv'), partyRoleListSubViewTemplate,  {model:self.model, relatedFieldName:"partyRole", entities_strings:entities_strings, selectedOption:self.options.selectedOption});
            });
            return this;
        }
    });
