...
) values (2, 4, 1, '127.0.0.1', NULL, '/home/administrator/Projects/alantra/data/cts/cheque_txn.csv', NULL, NULL,  'I', '', '', 'N', 'CTS_CHQ_TXN_DATA_CSV_DATASOURCE', 'CTS Cheque Transactions CSV Data Source', 'CTS Cheque Transactions CSV Data Source', '2012-04-04', 'A', 1, '2012-04-04', '2012-04-04', 'Admin', '2012-04-04', 'Admin' );

INSERT INTO DATA_CHANNEL (CHANNEL_CLASS_ID, CHANNEL_TY_ID, CHANNEL_STATUS_ID, IP_ADDR, PORT_NO, URL, USERNAME, PASSWORD, INBOUND_OUTBOUND_CD, CONN_SECURITY_CD, AUTH_METHOD_CD, LOCAL_SERVICE_FG, CODE, NAME, DESCRIPTION, EFFECTIVE_DT, REC_ST , VERSION_NO, ROW_TS, CREATED_DT, CREATED_BY_USR, LAST_MODIFIED_DT, LAST_MODIFIED_USR
) values (2, 4, 1, '127.0.0.1', NULL, '/home/administrator/Projects/alantra/data/customer/customer_data.csv', NULL, NULL, 'I', '', '', 'N', 'CUST_ACCT_DATA_CSV_DATASOURCE', 'Customer And Account Information CSV Data Sourcece', 'Customer And Account Information CSV Data Source', '2012-04-04', 'A', 1, '2012-04-04', '2012-04-04', 'Admin', '2012-04-04', 'Admin' );

INSERT INTO DATA_CHANNEL (CHANNEL_CLASS_ID, CHANNEL_TY_ID, CHANNEL_STATUS_ID, IP_ADDR, PORT_NO, URL, USERNAME, PASSWORD, INBOUND_OUTBOUND_CD, CONN_SECURITY_CD, AUTH_METHOD_CD, LOCAL_SERVICE_FG, CODE, NAME, DESCRIPTION, EFFECTIVE_DT, REC_ST , VERSION_NO, ROW_TS, CREATED_DT, CREATED_BY_USR, LAST_MODIFIED_DT, LAST_MODIFIED_USR
) values (2, 4, 1, '127.0.0.1', NULL, '/home/administrator/Projects/alantra/data/advice/advice_data.csv', NULL, NULL, 'I', '', '', 'N', 'ADVICE_REQUEST_DATA_CSV_DATASOURCE', 'Advice Request CSV Data Source', 'Advice Request CSV Data Source', '2012-04-04', 'A', 1, '2012-04-04', '2012-04-04', 'Admin', '2012-04-04', 'Admin' );

INSERT INTO DATA_CHANNEL (CHANNEL_CLASS_ID, CHANNEL_TY_ID, CHANNEL_STATUS_ID, IP_ADDR, PORT_NO, URL, USERNAME, PASSWORD, INBOUND_OUTBOUND_CD, CONN_SECURITY_CD, AUTH_METHOD_CD, LOCAL_SERVICE_FG, CODE, NAME, DESCRIPTION, EFFECTIVE_DT, REC_ST , VERSION_NO, ROW_TS, CREATED_DT, CREATED_BY_USR, LAST_MODIFIED_DT, LAST_MODIFIED_USR
) values (2, 5, 1, '127.0.0.1', NULL, '/home/administrator/Projects/alantra/data/cts/cheque_txn.xls', NULL, NULL, 'I', '', '', 'N', 'CTS_CHQ_TXN_DATA_EXCEL_DATASOURCE', 'CTS Cheque Transactions Excel Data Source', 'CTS Cheque Transactions Excel Data Source', '2012-04-04', 'A', 1, '2012-04-04', '2012-04-04', 'Admin', '2012-04-04', 'Admin' );

INSERT INTO DATA_CHANNEL (CHANNEL_CLASS_ID, CHANNEL_TY_ID, CHANNEL_STATUS_ID, IP_ADDR, PORT_NO, URL, USERNAME, PASSWORD, INBOUND_OUTBOUND_CD, CONN_SECURITY_CD, AUTH_METHOD_CD, LOCAL_SERVICE_FG, CODE, NAME, DESCRIPTION, EFFECTIVE_DT, REC_ST , VERSION_NO, ROW_TS, CREATED_DT, CREATED_BY_USR, LAST_MODIFIED_DT, LAST_MODIFIED_USR
) values (2, 3, 1, '127.0.0.1', 8083, '/home/administrator/Projects/alantra/data/cts/cheque_txn.xls', NULL, NULL, 'I', '', '', 'Y', 'SERVER_TEST', 'QTM Service Test', 'QTM Service Test', '2012-04-04', 'A', 1, '2012-04-04', '2012-04-04', 'Admin', '2012-04-04', 'Admin' );
...
INSERT INTO TRANSACTION_RULE (RULE_TY_ID, RULE_ACTION_ID, CODE, NAME, DESCRIPTION, OPERATOR_MODE_FG, EFFECTIVE_DT, REC_ST , VERSION_NO, ROW_TS, CREATED_DT, CREATED_BY_USR, LAST_MODIFIED_DT, LAST_MODIFIED_USR
) values (1,1, 'VALIDATE_TXN_ATRTIBUTES_RULE', 'Transaction Attributes Validation Rule', "A rule to validate a transaction's attributes", 'A', '2012-04-04', 'A', 1, '2012-04-04', '2012-04-04', 'Admin', '2012-04-04', 'Admin' );
...
INSERT INTO DATA_FIELD (DATA_STRUCT_ID, DATA_FIELD_TY_ID, DATA_TRANSFORMER_ID, CODE, NAME, DESCRIPTION, TARGET_ENTITY_CD, TARGET_ENTITY_FIELD, REL_TARGET_ENTITY_CD, REQUIRED_FG, SEQ_NO, EFFECTIVE_DT, REC_ST , VERSION_NO, ROW_TS, CREATED_DT, CREATED_BY_USR, LAST_MODIFIED_DT, LAST_MODIFIED_USR
) values (1, 1, 1, 'EMAIL_MSG_ID', 'Message Id', 'Message Id', 'Message', 'code', '', 'Y', 1, '2012-04-04', 'A', 1, '2012-04-04', '2012-04-04', 'Admin', '2012-04-04', 'Admin' );

INSERT INTO DATA_FIELD (DATA_STRUCT_ID, DATA_FIELD_TY_ID, DATA_TRANSFORMER_ID, CODE, NAME, DESCRIPTION, TARGET_ENTITY_CD, TARGET_ENTITY_FIELD, REQUIRED_FG, SEQ_NO, EFFECTIVE_DT, REC_ST , VERSION_NO, ROW_TS, CREATED_DT, CREATED_BY_USR, LAST_MODIFIED_DT, LAST_MODIFIED_USR
) values (1, 1, 1, 'EMAIL_FROM', 'Message From', 'Message From', 'Message', 'messageFrom', 'Y', 2, '2012-04-04', 'A', 1, '2012-04-04', '2012-04-04', 'Admin', '2012-04-04', 'Admin' );

INSERT INTO DATA_FIELD (DATA_STRUCT_ID, DATA_FIELD_TY_ID, DATA_TRANSFORMER_ID, CODE, NAME, DESCRIPTION, TARGET_ENTITY_CD, TARGET_ENTITY_FIELD, REL_TARGET_ENTITY_CD, REQUIRED_FG, SEQ_NO, EFFECTIVE_DT, REC_ST , VERSION_NO, ROW_TS, CREATED_DT, CREATED_BY_USR, LAST_MODIFIED_DT, LAST_MODIFIED_USR
) values (1, 1, 1, 'EMAIL_TO', 'Message To', 'Message To', 'Message', 'messageTo', '', 'Y', 3, '2012-04-04', 'A', 1, '2012-04-04', '2012-04-04', 'Admin', '2012-04-04', 'Admin' );

INSERT INTO DATA_FIELD (DATA_STRUCT_ID, DATA_FIELD_TY_ID, DATA_TRANSFORMER_ID, CODE, NAME, DESCRIPTION, TARGET_ENTITY_CD, TARGET_ENTITY_FIELD, REQUIRED_FG, SEQ_NO, EFFECTIVE_DT, REC_ST , VERSION_NO, ROW_TS, CREATED_DT, CREATED_BY_USR, LAST_MODIFIED_DT, LAST_MODIFIED_USR
) values (1, 1, 1, 'EMAIL_SUBJECT', 'Message Subject', 'Message Subject', 'Message', 'messageSubject', 'Y', 4, '2012-04-04', 'A', 1, '2012-04-04', '2012-04-04', 'Admin', '2012-04-04', 'Admin' );

INSERT INTO DATA_FIELD (DATA_STRUCT_ID, DATA_FIELD_TY_ID, DATA_TRANSFORMER_ID, CODE, NAME, DESCRIPTION, TARGET_ENTITY_CD, TARGET_ENTITY_FIELD, REQUIRED_FG, SEQ_NO, EFFECTIVE_DT, REC_ST , VERSION_NO, ROW_TS, CREATED_DT, CREATED_BY_USR, LAST_MODIFIED_DT, LAST_MODIFIED_USR
) values (1, 1, 1, 'EMAIL_BODY', 'Message Body', 'Message Body', 'Message', 'messageTxt', 'Y', 5, '2012-04-04', 'A', 1, '2012-04-04', '2012-04-04', 'Admin', '2012-04-04', 'Admin' );

INSERT INTO DATA_FIELD (DATA_STRUCT_ID, DATA_FIELD_TY_ID, DATA_TRANSFORMER_ID, CODE, NAME, DESCRIPTION, TARGET_ENTITY_CD, TARGET_ENTITY_FIELD, REQUIRED_FG, SEQ_NO, EFFECTIVE_DT, REC_ST , VERSION_NO, ROW_TS, CREATED_DT, CREATED_BY_USR, LAST_MODIFIED_DT, LAST_MODIFIED_USR
) values (1, 1, 1, 'EMAIL_ATTACHMENT_DATA_TYPE', 'Message Attachment Data Type', 'Message Attachment Data Type', 'MessageAttachements', 'dataTy', 'Y', 6, '2012-04-04', 'A', 1, '2012-04-04', '2012-04-04', 'Admin', '2012-04-04', 'Admin' );

INSERT INTO DATA_FIELD (DATA_STRUCT_ID, DATA_FIELD_TY_ID, DATA_TRANSFORMER_ID, CODE, NAME, DESCRIPTION, TARGET_ENTITY_CD, TARGET_ENTITY_FIELD, REQUIRED_FG, SEQ_NO, EFFECTIVE_DT, REC_ST , VERSION_NO, ROW_TS, CREATED_DT, CREATED_BY_USR, LAST_MODIFIED_DT, LAST_MODIFIED_USR
) values (1, 1, 1, 'EMAIL_ATTACHMENT_DATA_URL', 'Message Attachment Location', 'Message Attachment Location', 'MessageAttachements', 'dataUrl', 'Y', 7, '2012-04-04', 'A', 1, '2012-04-04', '2012-04-04', 'Admin', '2012-04-04', 'Admin' );


INSERT INTO DATA_FIELD (DATA_STRUCT_ID, DATA_FIELD_TY_ID, DATA_TRANSFORMER_ID, CODE, NAME, DESCRIPTION, TARGET_ENTITY_CD, TARGET_ENTITY_FIELD, REL_TARGET_ENTITY_CD, REQUIRED_FG, SEQ_NO, EFFECTIVE_DT, REC_ST , VERSION_NO, ROW_TS, CREATED_DT, CREATED_BY_USR, LAST_MODIFIED_DT, LAST_MODIFIED_USR
) values (2, 5, 1, 'ACCOUNT_NO', 'acct_no', 'Account Number', 'ServiceTransaction', 'customerAccount', 'CustomerAccount', 'Y', 1, '2012-04-04', 'A', 1, '2012-04-04', '2012-04-04', 'Admin', '2012-04-04', 'Admin' );

INSERT INTO DATA_FIELD (DATA_STRUCT_ID, DATA_FIELD_TY_ID, DATA_TRANSFORMER_ID, CODE, NAME, DESCRIPTION, TARGET_ENTITY_CD, TARGET_ENTITY_FIELD, REQUIRED_FG, SEQ_NO, EFFECTIVE_DT, REC_ST , VERSION_NO, ROW_TS, CREATED_DT, CREATED_BY_USR, LAST_MODIFIED_DT, LAST_MODIFIED_USR
) values (2, 3, 1, 'AMOUNT', 'amount', 'Transaction Amount', 'ServiceTransaction', 'amount',  'Y', 2, '2012-04-04', 'A', 1, '2012-04-04', '2012-04-04', 'Admin', '2012-04-04', 'Admin' );

INSERT INTO DATA_FIELD (DATA_STRUCT_ID, DATA_FIELD_TY_ID, DATA_TRANSFORMER_ID, CODE, NAME, DESCRIPTION, TARGET_ENTITY_CD, TARGET_ENTITY_FIELD, REL_TARGET_ENTITY_CD, REQUIRED_FG, SEQ_NO, EFFECTIVE_DT, REC_ST , VERSION_NO, ROW_TS, CREATED_DT, CREATED_BY_USR, LAST_MODIFIED_DT, LAST_MODIFIED_USR
) values (2, 5, 1, 'CURRENCY', 'crncy', 'Currency', 'ServiceTransaction', 'currency', 'Currency', 'Y', 3, '2012-04-04', 'A', 1, '2012-04-04', '2012-04-04', 'Admin', '2012-04-04', 'Admin' );

INSERT INTO DATA_FIELD (DATA_STRUCT_ID, DATA_FIELD_TY_ID, DATA_TRANSFORMER_ID, CODE, NAME, DESCRIPTION, TARGET_ENTITY_CD, TARGET_ENTITY_FIELD, REQUIRED_FG, SEQ_NO, EFFECTIVE_DT, REC_ST , VERSION_NO, ROW_TS, CREATED_DT, CREATED_BY_USR, LAST_MODIFIED_DT, LAST_MODIFIED_USR
) values (2, 1, 1, 'CHEQUE_NO', 'Cheque Number', 'Cheque Number', 'ServiceTransaction', 'chequeNo', 'Y', 4, '2012-04-04', 'A', 1, '2012-04-04', '2012-04-04', 'Admin', '2012-04-04', 'Admin' );

INSERT INTO DATA_FIELD (DATA_STRUCT_ID, DATA_FIELD_TY_ID, DATA_TRANSFORMER_ID, CODE, NAME, DESCRIPTION, TARGET_ENTITY_CD, TARGET_ENTITY_FIELD, REQUIRED_FG, SEQ_NO, EFFECTIVE_DT, REC_ST , VERSION_NO, ROW_TS, CREATED_DT, CREATED_BY_USR, LAST_MODIFIED_DT, LAST_MODIFIED_USR
) values (2, 4, 1, 'TXN_DATE', 'txn_dt', 'Transaction Date', 'ServiceTransaction', 'txnDate', 'Y', 5, '2012-04-04', 'A', 1, '2012-04-04', '2012-04-04', 'Admin', '2012-04-04', 'Admin' );


INSERT INTO DATA_FIELD (DATA_STRUCT_ID, DATA_FIELD_TY_ID, DATA_TRANSFORMER_ID, CODE, NAME, DESCRIPTION, TARGET_ENTITY_CD, TARGET_ENTITY_FIELD, REQUIRED_FG, SEQ_NO, EFFECTIVE_DT, REC_ST , VERSION_NO, ROW_TS, CREATED_DT, CREATED_BY_USR, LAST_MODIFIED_DT, LAST_MODIFIED_USR
) values (3, 1, 1, 'BRANCH_CODE', 'Branch', 'Branch', '', '', 'Y', 1, '2012-04-04', 'A', 1, '2012-04-04', '2012-04-04', 'Admin', '2012-04-04', 'Admin' );

INSERT INTO DATA_FIELD (DATA_STRUCT_ID, DATA_FIELD_TY_ID, DATA_TRANSFORMER_ID, CODE, NAME, DESCRIPTION, TARGET_ENTITY_CD, TARGET_ENTITY_FIELD, REQUIRED_FG, SEQ_NO, EFFECTIVE_DT, REC_ST , VERSION_NO, ROW_TS, CREATED_DT, CREATED_BY_USR, LAST_MODIFIED_DT, LAST_MODIFIED_USR
) values (3, 1, 1, 'CLEARING_NO', 'Clearing No', 'Clearing No', 'Customer', 'code', 'Y', 2, '2012-04-04', 'A', 1, '2012-04-04', '2012-04-04', 'Admin', '2012-04-04', 'Admin' );

INSERT INTO DATA_FIELD (DATA_STRUCT_ID, DATA_FIELD_TY_ID, DATA_TRANSFORMER_ID, CODE, NAME, DESCRIPTION, TARGET_ENTITY_CD, TARGET_ENTITY_FIELD, REQUIRED_FG, SEQ_NO, EFFECTIVE_DT, REC_ST , VERSION_NO, ROW_TS, CREATED_DT, CREATED_BY_USR, LAST_MODIFIED_DT, LAST_MODIFIED_USR
) values (3, 1, 1, 'CUST_ACCOUNT_NO', 'Account No', 'Account No', 'Account', 'accountNo', 'Y', 3, '2012-04-04', 'A', 1, '2012-04-04', '2012-04-04', 'Admin', '2012-04-04', 'Admin' );

INSERT INTO DATA_FIELD (DATA_STRUCT_ID, DATA_FIELD_TY_ID, DATA_TRANSFORMER_ID, CODE, NAME, DESCRIPTION, TARGET_ENTITY_CD, TARGET_ENTITY_FIELD, REQUIRED_FG, SEQ_NO, EFFECTIVE_DT, REC_ST , VERSION_NO, ROW_TS, CREATED_DT, CREATED_BY_USR, LAST_MODIFIED_DT, LAST_MODIFIED_USR
) values (3, 1, 1, 'ALT_ACCOUNT_NO', 'Alternate Account Number', 'Alternate Account Number', '', '', 'Y', 4, '2012-04-04', 'A', 1, '2012-04-04', '2012-04-04', 'Admin', '2012-04-04', 'Admin' );

INSERT INTO DATA_FIELD (DATA_STRUCT_ID, DATA_FIELD_TY_ID, DATA_TRANSFORMER_ID, CODE, NAME, DESCRIPTION, TARGET_ENTITY_CD, TARGET_ENTITY_FIELD, REQUIRED_FG, SEQ_NO, EFFECTIVE_DT, REC_ST , VERSION_NO, ROW_TS, CREATED_DT, CREATED_BY_USR, LAST_MODIFIED_DT, LAST_MODIFIED_USR
) values (3, 1, 1, 'CUST_CURRENCY', 'Customer Currency', 'Currency', '', '', 'Y', 5, '2012-04-04', 'A', 1, '2012-04-04', '2012-04-04', 'Admin', '2012-04-04', 'Admin' );

INSERT INTO DATA_FIELD (DATA_STRUCT_ID, DATA_FIELD_TY_ID, DATA_TRANSFORMER_ID, CODE, NAME, DESCRIPTION, TARGET_ENTITY_CD, TARGET_ENTITY_FIELD, REQUIRED_FG, SEQ_NO, EFFECTIVE_DT, REC_ST , VERSION_NO, ROW_TS, CREATED_DT, CREATED_BY_USR, LAST_MODIFIED_DT, LAST_MODIFIED_USR
) values (3, 1, 1, 'CUST_NAME', 'Name', 'Name', 'Customer', 'Name', 'Y', 6, '2012-04-04', 'A', 1, '2012-04-04', '2012-04-04', 'Admin', '2012-04-04', 'Admin' );

INSERT INTO DATA_FIELD (DATA_STRUCT_ID, DATA_FIELD_TY_ID, DATA_TRANSFORMER_ID, CODE, NAME, DESCRIPTION, TARGET_ENTITY_CD, TARGET_ENTITY_FIELD, REQUIRED_FG, SEQ_NO, EFFECTIVE_DT, REC_ST , VERSION_NO, ROW_TS, CREATED_DT, CREATED_BY_USR, LAST_MODIFIED_DT, LAST_MODIFIED_USR
) values (3, 1, 1, 'ACCOUNT_STATUS', 'Status', 'Status', '', '', 'Y', 7, '2012-04-04', 'A', 1, '2012-04-04', '2012-04-04', 'Admin', '2012-04-04', 'Admin' );

INSERT INTO DATA_FIELD (DATA_STRUCT_ID, DATA_FIELD_TY_ID, DATA_TRANSFORMER_ID, CODE, NAME, DESCRIPTION, TARGET_ENTITY_CD, TARGET_ENTITY_FIELD, REQUIRED_FG, SEQ_NO, EFFECTIVE_DT, REC_ST , VERSION_NO, ROW_TS, CREATED_DT, CREATED_BY_USR, LAST_MODIFIED_DT, LAST_MODIFIED_USR
) values (3, 1, 1, 'ACCOUNT_STATE', 'State', 'State', '', '', 'Y', 8, '2012-04-04', 'A', 1, '2012-04-04', '2012-04-04', 'Admin', '2012-04-04', 'Admin' );

INSERT INTO DATA_FIELD (DATA_STRUCT_ID, DATA_FIELD_TY_ID, DATA_TRANSFORMER_ID, CODE, NAME, DESCRIPTION, TARGET_ENTITY_CD, TARGET_ENTITY_FIELD, REQUIRED_FG, SEQ_NO, EFFECTIVE_DT, REC_ST , VERSION_NO, ROW_TS, CREATED_DT, CREATED_BY_USR, LAST_MODIFIED_DT, LAST_MODIFIED_USR
) values (3, 1, 1, 'ADDRESS', 'Address', 'Address', '', '', 'Y', 9, '2012-04-04', 'A', 1, '2012-04-04', '2012-04-04', 'Admin', '2012-04-04', 'Admin' );

INSERT INTO DATA_FIELD (DATA_STRUCT_ID, DATA_FIELD_TY_ID, DATA_TRANSFORMER_ID, CODE, NAME, DESCRIPTION, TARGET_ENTITY_CD, TARGET_ENTITY_FIELD, REQUIRED_FG, SEQ_NO, EFFECTIVE_DT, REC_ST , VERSION_NO, ROW_TS, CREATED_DT, CREATED_BY_USR, LAST_MODIFIED_DT, LAST_MODIFIED_USR
) values (3, 1, 1, 'PHONE', 'Phone', 'Phone', 'Customer', 'primaryMobile', 'Y', 10, '2012-04-04', 'A', 1, '2012-04-04', '2012-04-04', 'Admin', '2012-04-04', 'Admin' );

INSERT INTO DATA_FIELD (DATA_STRUCT_ID, DATA_FIELD_TY_ID, DATA_TRANSFORMER_ID, CODE, NAME, DESCRIPTION, TARGET_ENTITY_CD, TARGET_ENTITY_FIELD, REQUIRED_FG, SEQ_NO, EFFECTIVE_DT, REC_ST , VERSION_NO, ROW_TS, CREATED_DT, CREATED_BY_USR, LAST_MODIFIED_DT, LAST_MODIFIED_USR
) values (3, 1, 1, 'EMAIL', 'Email', 'Email', 'Customer', 'primaryEmail', 'Y', 11, '2012-04-04', 'A', 1, '2012-04-04', '2012-04-04', 'Admin', '2012-04-04', 'Admin' );


INSERT INTO DATA_FIELD (DATA_STRUCT_ID, DATA_FIELD_TY_ID, DATA_TRANSFORMER_ID, CODE, NAME, DESCRIPTION, TARGET_ENTITY_CD, TARGET_ENTITY_FIELD, REL_TARGET_ENTITY_CD, REQUIRED_FG, SEQ_NO, EFFECTIVE_DT, REC_ST , VERSION_NO, ROW_TS, CREATED_DT, CREATED_BY_USR, LAST_MODIFIED_DT, LAST_MODIFIED_USR
) values (4, 1, 1, 'ADVICE_CURRENCY', 'Advice currency', 'Advice currency', 'AdviceRequestMessage', 'currencyCd', 'Currency', 'Y', 1, '2012-04-04', 'A', 1, '2012-04-04', '2012-04-04', 'Admin', '2012-04-04', 'Admin' );

INSERT INTO DATA_FIELD (DATA_STRUCT_ID, DATA_FIELD_TY_ID, DATA_TRANSFORMER_ID, CODE, NAME, DESCRIPTION, TARGET_ENTITY_CD, TARGET_ENTITY_FIELD, REQUIRED_FG, SEQ_NO, EFFECTIVE_DT, REC_ST , VERSION_NO, ROW_TS, CREATED_DT, CREATED_BY_USR, LAST_MODIFIED_DT, LAST_MODIFIED_USR
) values (4, 3, 1, 'ADVICE_AMOUNT', 'Advice amount', 'Advice amount', 'AdviceRequestMessage', 'amount', 'Y', 2, '2012-04-04', 'A', 1, '2012-04-04', '2012-04-04', 'Admin', '2012-04-04', 'Admin' );

INSERT INTO DATA_FIELD (DATA_STRUCT_ID, DATA_FIELD_TY_ID, DATA_TRANSFORMER_ID, CODE, NAME, DESCRIPTION, TARGET_ENTITY_CD, TARGET_ENTITY_FIELD, REL_TARGET_ENTITY_CD, REQUIRED_FG, SEQ_NO, EFFECTIVE_DT, REC_ST , VERSION_NO, ROW_TS, CREATED_DT, CREATED_BY_USR, LAST_MODIFIED_DT, LAST_MODIFIED_USR
) values (4, 1, 1, 'ADVICE_ACCOUNT_NO', 'Advice account number', 'Advice account number', 'AdviceRequestMessage', 'accountNo', '', 'Y', 3, '2012-04-04', 'A', 1, '2012-04-04', '2012-04-04', 'Admin', '2012-04-04', 'Admin' );

INSERT INTO DATA_FIELD (DATA_STRUCT_ID, DATA_FIELD_TY_ID, DATA_TRANSFORMER_ID, CODE, NAME, DESCRIPTION, TARGET_ENTITY_CD, TARGET_ENTITY_FIELD, REQUIRED_FG, SEQ_NO, EFFECTIVE_DT, REC_ST , VERSION_NO, ROW_TS, CREATED_DT, CREATED_BY_USR, LAST_MODIFIED_DT, LAST_MODIFIED_USR
) values (4, 1, 1, 'ADVICE_CHEQUE_NO', 'Advice cheque number', 'Advice cheque number', 'AdviceRequestMessage', 'chequeNo', 'Y', 4, '2012-04-04', 'A', 1, '2012-04-04', '2012-04-04', 'Admin', '2012-04-04', 'Admin' );

INSERT INTO DATA_FIELD (DATA_STRUCT_ID, DATA_FIELD_TY_ID, DATA_TRANSFORMER_ID, CODE, NAME, DESCRIPTION, TARGET_ENTITY_CD, TARGET_ENTITY_FIELD, REQUIRED_FG, SEQ_NO, EFFECTIVE_DT, REC_ST , VERSION_NO, ROW_TS, CREATED_DT, CREATED_BY_USR, LAST_MODIFIED_DT, LAST_MODIFIED_USR
) values (4, 1, 1, 'ADVICE_CARD_NO', 'Advice card number', 'Advice card number', 'AdviceRequestMessage', 'cardNo', 'Y', 5, '2012-04-04', 'A', 1, '2012-04-04', '2012-04-04', 'Admin', '2012-04-04', 'Admin' );

INSERT INTO DATA_FIELD (DATA_STRUCT_ID, DATA_FIELD_TY_ID, DATA_TRANSFORMER_ID, CODE, NAME, DESCRIPTION, TARGET_ENTITY_CD, TARGET_ENTITY_FIELD, REQUIRED_FG, SEQ_NO, EFFECTIVE_DT, REC_ST , VERSION_NO, ROW_TS, CREATED_DT, CREATED_BY_USR, LAST_MODIFIED_DT, LAST_MODIFIED_USR
) values (4, 1, 1, 'ADVICE_TEXT', 'Advice text', 'Advice text', 'AdviceRequestMessage', 'name', 'Y', 6, '2012-04-04', 'A', 1, '2012-04-04', '2012-04-04', 'Admin', '2012-04-04', 'Admin' );
...
) values (1, 1, 'EMAIL_MESSAGE_DATA', 'Email Message Data', 'Email Message Data', '2012-04-04', 'A', 1, '2012-04-04', '2012-04-04', 'Admin', '2012-04-04', 'Admin' );

INSERT INTO DATA (DATA_TY_ID, DATA_STRUCT_ID, CODE, NAME, DESCRIPTION, EFFECTIVE_DT, REC_ST , VERSION_NO, ROW_TS, CREATED_DT, CREATED_BY_USR, LAST_MODIFIED_DT, LAST_MODIFIED_USR
) values (2, 2, 'CTS_TRANSACTION_DATA', 'CTS Transactional Data', 'CTS Transaction data', '2012-04-04', 'A', 1, '2012-04-04', '2012-04-04', 'Admin', '2012-04-04', 'Admin' );

INSERT INTO DATA (DATA_TY_ID, DATA_STRUCT_ID, CODE, NAME, DESCRIPTION, EFFECTIVE_DT, REC_ST , VERSION_NO, ROW_TS, CREATED_DT, CREATED_BY_USR, LAST_MODIFIED_DT, LAST_MODIFIED_USR
) values (3, 3, 'CBS_CUSTOMER_DATA', 'CBS Customer And Account Data', 'CBS Customer And Account Data', '2012-04-04', 'A', 1, '2012-04-04', '2012-04-04', 'Admin', '2012-04-04', 'Admin' );

INSERT INTO DATA (DATA_TY_ID, DATA_STRUCT_ID, CODE, NAME, DESCRIPTION, EFFECTIVE_DT, REC_ST , VERSION_NO, ROW_TS, CREATED_DT, CREATED_BY_USR, LAST_MODIFIED_DT, LAST_MODIFIED_USR
) values (4, 4, 'ADVICE_REQUEST_DATA', 'Advice Request Data', 'Advice Request Data', '2012-04-04', 'A', 1, '2012-04-04', '2012-04-04', 'Admin', '2012-04-04', 'Admin' );

INSERT INTO DATA (DATA_TY_ID, DATA_STRUCT_ID, CODE, NAME, DESCRIPTION, EFFECTIVE_DT, REC_ST , VERSION_NO, ROW_TS, CREATED_DT, CREATED_BY_USR, LAST_MODIFIED_DT, LAST_MODIFIED_USR
) values (2, 2, 'CTS_EXCEL_TRANSACTION_DATA', 'CTS Excel Transactional Data', 'CTS Excel Transaction data', '2012-04-04', 'A', 1, '2012-04-04', '2012-04-04', 'Admin', '2012-04-04', 'Admin' );
...
) values (1, 1, 'EMAIL_MASSAGE_DATA_INPUT_CONFIG', 'Email Message Data Input Configuration', 'Email Message Data Input Configuration', '2012-04-04', 'A', 1, '2012-04-04', '2012-04-04', 'Admin', '2012-04-04', 'Admin' );

INSERT INTO DATA_INPUT (DATA_ID, CHANNEL_ID, CODE, NAME, DESCRIPTION, EFFECTIVE_DT, REC_ST , VERSION_NO, ROW_TS, CREATED_DT, CREATED_BY_USR, LAST_MODIFIED_DT, LAST_MODIFIED_USR
) values (2, 3, 'CTS_TRANSACTION_DATA_INPUT_CONFIG', 'CTS Transactional Data Input Configuration', 'CTS Transactional Data Input Configuration', '2012-04-04', 'A', 1, '2012-04-04', '2012-04-04', 'Admin', '2012-04-04', 'Admin' );

INSERT INTO DATA_INPUT (DATA_ID, CHANNEL_ID, CODE, NAME, DESCRIPTION, EFFECTIVE_DT, REC_ST , VERSION_NO, ROW_TS, CREATED_DT, CREATED_BY_USR, LAST_MODIFIED_DT, LAST_MODIFIED_USR
) values (3, 4, 'CBS_CUSTOMER_DATA_INPUT_CONFIG', 'CBS Customer Data Input Configuration', 'CBS Customer Transactional Data Input Configuration', '2012-04-04', 'A', 1, '2012-04-04', '2012-04-04', 'Admin', '2012-04-04', 'Admin' );

INSERT INTO DATA_INPUT (DATA_ID, CHANNEL_ID, CODE, NAME, DESCRIPTION, EFFECTIVE_DT, REC_ST , VERSION_NO, ROW_TS, CREATED_DT, CREATED_BY_USR, LAST_MODIFIED_DT, LAST_MODIFIED_USR
) values (4, 5, 'ADVICE_REQUEST_DATA_INPUT_CONFIG', 'Advice Request Data Input Configuration', 'Advice Request Data Input Configuration', '2012-04-04', 'A', 1, '2012-04-04', '2012-04-04', 'Admin', '2012-04-04', 'Admin' );

INSERT INTO DATA_INPUT (DATA_ID, CHANNEL_ID, CODE, NAME, DESCRIPTION, EFFECTIVE_DT, REC_ST , VERSION_NO, ROW_TS, CREATED_DT, CREATED_BY_USR, LAST_MODIFIED_DT, LAST_MODIFIED_USR
) values (5, 6, 'CTS_EXCEL_TRANSACTION_DATA_INPUT_CONFIG', 'CTS Excel Transactional Data Input Configuration', 'CTS Excel Transactional Data Input Configuration', '2012-04-04', 'A', 1, '2012-04-04', '2012-04-04', 'Admin', '2012-04-04', 'Admin' );
