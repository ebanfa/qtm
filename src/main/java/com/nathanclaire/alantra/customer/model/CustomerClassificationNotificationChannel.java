 ...
 */
@Entity
@Table(name="CUSTOMER_CLASSIFICATION_NOTIFICATION_CHANNEL"
    ,catalog="alantra"
    ,uniqueConstraints = @UniqueConstraint(columnNames="CODE") 
)
@JsonIgnoreProperties({"hibernateLazyInitializer", "handler"})
@JsonSerialize(include=JsonSerialize.Inclusion.NON_NULL)
public class CustomerClassificationNotificationChannel  extends BaseEntity implements java.io.Serializable {

	private DataChannelCategory dataChannelCategory;
	private CustomerClassification customerClassification;

    public CustomerClassificationNotificationChannel() {
    }

    public CustomerClassificationNotificationChannel(DataChannelCategory dataChannelCategory, CustomerClassification customerClassification, String code, Date effectiveDt, char recSt, Date createdDt, String createdByUsr) 
    {
		this.code = code;
    ...
    public CustomerClassificationNotificationChannel(DataChannelCategory dataChannelCategory, CustomerClassification customerClassification, String code, Date effectiveDt, char recSt, Date createdDt, String createdByUsr, Date lastModifiedDt, String lastModifiedUsr) 
    {
