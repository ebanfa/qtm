...
public class DataChannelRESTService extends BaseActivityRESTService<DataChannelResponse, DataChannelRequest> 
{
	...
	private Logger logger = LoggerFactory.getLogger(DataChannelRESTService.class);
	
	/* (non-Javadoc)
	 * @see com.nathanclaire.alantra.base.rest.BaseActivityRESTService#populateListActivityResponse(com.nathanclaire.alantra.datasource.response.DataChannelResponse, com.nathanclaire.alantra.base.response.ListActivityResponse, javax.ws.rs.core.MultivaluedMap)
	 */
	@Override
	protected ListActivityResponse<DataChannelResponse> populateListActivityResponse(
			ApplicationActivityResponse activity, ListActivityResponse<DataChannelResponse> response,
	 ...
	 */
	@Override
	protected EditActivityResponse<DataChannelResponse> populateEditActivityResponse(
	...
	@Override
	protected ListActivityResponse<DataChannelResponse> deleteEntityInstances(
