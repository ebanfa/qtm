...
public class DataRESTService extends BaseActivityRESTService<DataResponse, DataRequest> 
{
			...
			MultivaluedMap<String, String> queryParameters) throws ApplicationException 
	{
		...
		List<ApplicationEntityField> entityFields = dataService.getEntityFields();
		...
		for (Data item:dataService.findAll(queryParameters))
		{
			dataItems.add(dataService.convertModelToResponse(item));
		}
	...
	protected EditActivityResponse<DataResponse> populateEditActivityResponse(
		...
		response.setFields(responseFields);
		response.setRelatedEntitiesListData(dataService.relatedEntitesToListItems());
		if(id != null)
			response.setEntity(dataService.convertModelToResponse(dataService.findById(id)));
	...
	protected Map<String, List<ListItemResponse>> prepareRelatedEntitiesListItems(MultivaluedMap<String, String> multivaluedMap) 
				   throws ApplicationException {
		return dataService.relatedEntitesToListItems();
	}
	...
	protected EditActivityResponse<DataResponse> saveEntityInstance(
		...
		Data data = dataService.create(entityInstance);
	...
	protected EditActivityResponse<DataResponse> saveEditedEntityInstance(
			DataRequest entityInstance) throws ApplicationException {
		Data data = dataService.update(entityInstance);
		return this.getEditActivityResponse(data.getId());
	}
	...
	protected String getListActivityCode() throws ApplicationException {
		return dataService.getListActivityCode();
	}
	...
	protected String getEditActivityCode() throws ApplicationException {
		return dataService.getEditActivityCode();
	}
