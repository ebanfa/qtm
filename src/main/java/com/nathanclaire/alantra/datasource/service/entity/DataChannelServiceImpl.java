 ...
 */
@Stateless
public class DataChannelServiceImpl 
	...
	implements DataChannelService
{
	...
	private Logger logger = LoggerFactory.getLogger(DataChannelServiceImpl.class);
    ...
    public DataChannel convertRequestToModel(DataChannelRequest dataChannelRequest) 
     throws ApplicationException {
		...
		PropertyUtils.copyProperties(dataChannelRequest, dataChannel, allowedEntityFields);
	...
	public DataChannelResponse convertModelToResponse(DataChannel model) throws ApplicationException {
		...
		List<ApplicationEntityField> allowedEntityFields = this.getEntityFields();
		PropertyUtils.copyProperties(model, dataChannelResponse, allowedEntityFields);
