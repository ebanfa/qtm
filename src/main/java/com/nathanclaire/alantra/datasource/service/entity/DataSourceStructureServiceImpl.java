	...
	implements DataSourceStructureService
{
	 ...
	 */
	@Override
	public DataSourceStructure findById(Integer id) throws ApplicationException {
	 ...
	 */
	@Override
	public DataSourceStructure findByCode(String code) throws ApplicationException {
	 ...
	 */
	@Override
	public DataSourceStructure findByName(String name) throws ApplicationException {
	 ...
	 */
	@Override
	public List<DataSourceStructure> findAll(MultivaluedMap<String, String> queryParameters) throws ApplicationException {
	 ...
	 */
	@Override
	public DataSourceStructure create(DataSourceStructureRequest dataSourceStructureRequest) throws ApplicationException {
	 ...
	 */
	@Override
	public DataSourceStructure update(DataSourceStructureRequest dataSourceStructureRequest) throws ApplicationException {
	...
	@Override
	public DataSourceStructureResponse convertModelToResponse(DataSourceStructure model) throws ApplicationException {
