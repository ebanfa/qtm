	...
	implements DataInputEntityService
{
	...
	private Logger logger = LoggerFactory.getLogger(DataInputEntityServiceImpl.class);
	 ...
	 * @param entityClass
	 */
	public DataInputEntityServiceImpl() {
	...
	public Map<String, List<ListItemResponse>> relatedEntitesToListItems() 
	 throws ApplicationException {
		...
		List<ListItemResponse> datas = dataEntityService.asListItem();
    ...
    public DataInput convertRequestToModel(DataInputRequest dataInputRequest) 
     throws ApplicationException {
		...
		PropertyUtil.copyProperties(dataInputRequest, dataInput, allowedEntityFields);
	...
	public DataInputResponse convertModelToResponse(DataInput model) throws ApplicationException {
		...
		List<ApplicationEntityField> allowedEntityFields = this.getEntityFields();
		PropertyUtil.copyProperties(model, dataInputResponse, allowedEntityFields);
