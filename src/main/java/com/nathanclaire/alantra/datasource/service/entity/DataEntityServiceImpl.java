	...
	implements DataEntityService
{
    ...
    public Data convertRequestToModel(DataRequest dataRequest) 
     throws ApplicationException {
		...
		PropertyUtil.copyProperties(dataRequest, data, allowedEntityFields);
	...
	public DataResponse convertModelToResponse(Data model) throws ApplicationException {
		...
		List<ApplicationEntityField> allowedEntityFields = this.getEntityFields();
		PropertyUtil.copyProperties(model, dataResponse, allowedEntityFields);
