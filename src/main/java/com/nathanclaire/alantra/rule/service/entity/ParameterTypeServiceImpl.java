...
public class ParameterTypeServiceImpl 
	extends BaseEntityServiceImpl<ParameterType, ParameterTypeResponse, ParameterTypeRequest> 
	implements ParameterTypeService
{

	private static final String ENTITY_NAME = "ParameterType";
	private static final String LIST_ACTIVITY_CODE = "LIST_RULE_PARAMETERTYPE";
	private static final String EDIT_ACTIVITY_CODE = "EDIT_RULE_PARAMETERTYPE";
	
	private Logger logger = LoggerFactory.getLogger(ParameterTypeServiceImpl.class);
    ...
    /* (non-Javadoc)
	 * @see com.nathanclaire.alantra.parameterType.service.ParameterType#findById(java.lang.Integer)
	 */
	@Override
	public ParameterType findById(Integer id) throws ApplicationException {
		return getSingleInstance(id);
	}

	/* (non-Javadoc)
	 * @see com.nathanclaire.alantra.parameterType.service.ParameterType#findByCode(java.lang.String)
	 */
	@Override
	public ParameterType findByCode(String code) throws ApplicationException {
		return findInstanceByCode(code);
	}

	/* (non-Javadoc)
	 * @see com.nathanclaire.alantra.rule.service.ParameterType#findByName(java.lang.String)
	 */
	@Override
	public ParameterType findByName(String name) throws ApplicationException {
		return findInstanceByName(name);
	}

	/* (non-Javadoc)
	 * @see com.nathanclaire.alantra.rule.service.ParameterType#findAll(java.util.Map)
	 */
	@Override
	public List<ParameterType> findAll(MultivaluedMap<String, String> queryParameters) throws ApplicationException {
		return findAllInstances(queryParameters);
	}

	/* (non-Javadoc)
	 * @see com.nathanclaire.alantra.rule.service.ParameterType#createParameterType(com.nathanclaire.alantra.rule.rest.request.ServiceRequest)
	 */
	@Override
	public ParameterType create(ParameterTypeRequest parameterTypeRequest) throws ApplicationException {
		return createInstance(parameterTypeRequest);
	}

	/* (non-Javadoc)
	 * @see com.nathanclaire.alantra.rule.service.ParameterType#deleteParameterType(java.lang.Integer)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see com.nathanclaire.alantra.rule.service.ParameterType#updateParameterType(com.nathanclaire.alantra.parameterType.rest.request.ServiceRequest)
	 */
	@Override
	public ParameterType update(ParameterTypeRequest parameterTypeRequest) throws ApplicationException {
		return updateInstance(parameterTypeRequest);
	}
	...
	public List<ListItemResponse> asListItem() throws ApplicationException {
		...
		for(ParameterType parameterType: findAll(queryParameters))
		{
			ListItemResponse item = new ListItemResponse(parameterType.getId(), parameterType.getCode(), parameterType.getName());
			listItems.add(item);
		}
		return listItems;
	}
     ...
     */
	@Override
    public ParameterType convertRequestToModel(ParameterTypeRequest parameterTypeRequest) 
     throws ApplicationException {
		ParameterType parameterType = new ParameterType();
		// Copy properties
		List<ApplicationEntityField> allowedEntityFields = this.getEntityFields();
		PropertyUtil.copyProperties(parameterTypeRequest, parameterType, allowedEntityFields);
    	//Process many to one relationships
		return parameterType;
	}
	
	@Override
	public ParameterTypeResponse convertModelToResponse(ParameterType model) throws ApplicationException {
		if (model == null) return null;
		ParameterTypeResponse parameterTypeResponse = new ParameterTypeResponse();
		List<ApplicationEntityField> allowedEntityFields = this.getEntityFields();
		PropertyUtil.copyProperties(model, parameterTypeResponse, allowedEntityFields);
	...
	protected Predicate[] extractPredicates(
			MultivaluedMap<String, String> queryParameters,	CriteriaBuilder criteriaBuilder, Root<ParameterType> root) 
	{
