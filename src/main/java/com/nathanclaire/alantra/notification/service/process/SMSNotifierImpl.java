...
@Stateless
@SMSNotifier
public class SMSNotifierImpl extends BaseNotifier implements Notifier {
	...
	public void notifyCustomer(Customer customer, 
			NotificationType notificationType, Map<String, String> templateTagValues) throws ApplicationException 
	{
	 ...
	 */
	@Override
	public void notifyUser(SystemUser user, 
			NotificationType notificationType, Map<String, String> templateTagValues) throws ApplicationException {
