 ...
 */
@Stateless
public class TemplatingServiceImpl extends BaseProcessService implements TemplatingService 
{
	private Logger logger = LoggerFactory.getLogger(TemplatingServiceImpl.class);
	/* (non-Javadoc)
