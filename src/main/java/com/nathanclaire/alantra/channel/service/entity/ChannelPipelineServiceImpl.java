 ...
 */
@Stateless
public class ChannelPipelineServiceImpl 
	extends BaseEntityServiceImpl<ChannelPipeline, ChannelPipelineResponse, ChannelPipelineRequest> 
	implements ChannelPipelineService
{

	private static final String ENTITY_NAME = "ChannelPipeline";
	private static final String LIST_ACTIVITY_CODE = "LIST_CHANNEL_CHANNELPIPELINE";
	private static final String EDIT_ACTIVITY_CODE = "EDIT_CHANNEL_CHANNELPIPELINE";
	
	private Logger logger = LoggerFactory.getLogger(ChannelPipelineServiceImpl.class);
	 ...
	 * @param entityClass
	 */
	public ChannelPipelineServiceImpl() {
		super(ChannelPipeline.class);
	}

    /* (non-Javadoc)
	 * @see com.nathanclaire.alantra.channelPipeline.service.ChannelPipeline#findById(java.lang.Integer)
	 */
	@Override
	public ChannelPipeline findById(Integer id) throws ApplicationException {
		return getSingleInstance(id);
	}

	/* (non-Javadoc)
	 * @see com.nathanclaire.alantra.channelPipeline.service.ChannelPipeline#findByCode(java.lang.String)
	 */
	@Override
	public ChannelPipeline findByCode(String code) throws ApplicationException {
		return findInstanceByCode(code);
	}

	/* (non-Javadoc)
	 * @see com.nathanclaire.alantra.channel.service.ChannelPipeline#findByName(java.lang.String)
	 */
	@Override
	public ChannelPipeline findByName(String name) throws ApplicationException {
		return findInstanceByName(name);
	}

	/* (non-Javadoc)
	 * @see com.nathanclaire.alantra.channel.service.ChannelPipeline#findAll(java.util.Map)
	 */
	@Override
	public List<ChannelPipeline> findAll(MultivaluedMap<String, String> queryParameters) throws ApplicationException {
		return findAllInstances(queryParameters);
	}

	/* (non-Javadoc)
	 * @see com.nathanclaire.alantra.channel.service.ChannelPipeline#createChannelPipeline(com.nathanclaire.alantra.channel.rest.request.ServiceRequest)
	 */
	@Override
	public ChannelPipeline create(ChannelPipelineRequest channelPipelineRequest) throws ApplicationException {
		return createInstance(channelPipelineRequest);
	}

	/* (non-Javadoc)
	 * @see com.nathanclaire.alantra.channel.service.ChannelPipeline#deleteChannelPipeline(java.lang.Integer)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see com.nathanclaire.alantra.channel.service.ChannelPipeline#updateChannelPipeline(com.nathanclaire.alantra.channelPipeline.rest.request.ServiceRequest)
	 */
	@Override
	public ChannelPipeline update(ChannelPipelineRequest channelPipelineRequest) throws ApplicationException {
		return updateInstance(channelPipelineRequest);
	}
	...
	public List<ListItemResponse> asListItem() throws ApplicationException {
		...
		for(ChannelPipeline channelPipeline: findAll(queryParameters))
		{
			ListItemResponse item = new ListItemResponse(channelPipeline.getId(), channelPipeline.getCode(), channelPipeline.getName());
			listItems.add(item);
		}
		return listItems;
	}
     ...
     */
	@Override
    public ChannelPipeline convertRequestToModel(ChannelPipelineRequest channelPipelineRequest) 
     throws ApplicationException {
		ChannelPipeline channelPipeline = new ChannelPipeline();
		// Copy properties
		List<ApplicationEntityField> allowedEntityFields = this.getEntityFields();
		PropertyUtil.copyProperties(channelPipelineRequest, channelPipeline, allowedEntityFields);
    	//Process many to one relationships
		return channelPipeline;
	}
	
	@Override
	public ChannelPipelineResponse convertModelToResponse(ChannelPipeline model) throws ApplicationException {
		if (model == null) return null;
		ChannelPipelineResponse channelPipelineResponse = new ChannelPipelineResponse();
		List<ApplicationEntityField> allowedEntityFields = this.getEntityFields();
		PropertyUtil.copyProperties(model, channelPipelineResponse, allowedEntityFields);
	...
	protected Predicate[] extractPredicates(
			MultivaluedMap<String, String> queryParameters,	CriteriaBuilder criteriaBuilder, Root<ChannelPipeline> root) 
	{
