...
public class PartyRelationshipRESTService extends BaseEntityService<PartyRelationship> 
{
	 ...
	 * @param entityClass
	 */
	public PartyRelationshipRESTService() {
    ...
    private PartyRelationship loadModelFromRequest(PartyRelationshipRequest request) 
    {
    	...
    	if (request.getFromPartyRole() != null)
    	{
    		PartyRole fromPartyRole = entityManager.find(PartyRole.class, request.getFromPartyRole());
    		partyRelationship.setFromPartyRole(fromPartyRole);
    	}
    	if (request.getToPartyRole() != null)
    	{
    		PartyRole toPartyRole = entityManager.find(PartyRole.class, request.getToPartyRole());
