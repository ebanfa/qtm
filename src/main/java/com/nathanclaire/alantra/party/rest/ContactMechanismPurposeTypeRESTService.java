...
@Stateless
public class ContactMechanismPurposeTypeRESTService extends BaseEntityRESTService<ContactMechanismPurposeType> 
{
	/**
	 * @param entityClass
	 */
	public ContactMechanismPurposeTypeRESTService() {
