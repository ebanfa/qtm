...
import com.nathanclaire.alantra.base.rest.request.ProductOrderTypeRequest;
...
@Stateless
public class ProductOrderTypeService extends BaseEntityService<ProductOrderType> 
{
	/**
	 * @param entityClass
	 */
