...
public class AdviceRESTService extends BaseActivityRESTService<AdviceResponse, AdviceRequest> 
{
	...
	protected ListActivityResponse<AdviceResponse> populateListActivityResponse(
			ApplicationActivityResponse activity, ListActivityResponse<AdviceResponse> response,
	...
	protected EditActivityResponse<AdviceResponse> saveEntityInstance(
			AdviceRequest entityInstance) throws ApplicationException {
		Advice advice = adviceService.create(entityInstance);
		return this.getEditActivityResponse(advice.getId());
	}
	...
	protected EditActivityResponse<AdviceResponse> saveEditedEntityInstance(
			AdviceRequest entityInstance) throws ApplicationException {
		Advice advice = adviceService.update(entityInstance);
		return this.getEditActivityResponse(advice.getId());
	}
	
	@Override
	protected ListActivityResponse<AdviceResponse> deleteEntityInstances(
