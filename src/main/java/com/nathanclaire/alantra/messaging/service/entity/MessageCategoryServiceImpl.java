	...
	implements MessageCategoryService
{
    ...
    /* (non-Javadoc)
	 * @see com.nathanclaire.alantra.messageCategory.service.MessageCategory#findById(java.lang.Integer)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see com.nathanclaire.alantra.messageCategory.service.MessageCategory#findByCode(java.lang.String)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see com.nathanclaire.alantra.messaging.service.MessageCategory#updateMessageCategory(com.nathanclaire.alantra.messageCategory.rest.request.ServiceRequest)
	 */
	@Override
    ...
    public MessageCategory convertRequestToModel(MessageCategoryRequest messageCategoryRequest) 
     throws ApplicationException {
		...
		PropertyUtil.copyProperties(messageCategoryRequest, messageCategory, allowedEntityFields);
	...
	public MessageCategoryResponse convertModelToResponse(MessageCategory model) throws ApplicationException {
		...
		List<ApplicationEntityField> allowedEntityFields = this.getEntityFields();
		PropertyUtil.copyProperties(model, messageCategoryResponse, allowedEntityFields);
	...
	protected Predicate[] extractPredicates(
			MultivaluedMap<String, String> queryParameters,	CriteriaBuilder criteriaBuilder, Root<MessageCategory> root) 
	{
