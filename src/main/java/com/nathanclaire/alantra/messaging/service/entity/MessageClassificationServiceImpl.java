	...
	implements MessageClassificationService
{
    ...
    /* (non-Javadoc)
	 * @see com.nathanclaire.alantra.messageClassification.service.MessageClassification#findById(java.lang.Integer)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see com.nathanclaire.alantra.messageClassification.service.MessageClassification#findByCode(java.lang.String)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see com.nathanclaire.alantra.messaging.service.MessageClassification#updateMessageClassification(com.nathanclaire.alantra.messageClassification.rest.request.ServiceRequest)
	 */
	@Override
	 ...
	 * @param chequeNo
	 * @param currencyId
	 * @param messageClassificationTypeId
	 * @param amount
	 */
	...
	protected Predicate[] extractPredicates(
			MultivaluedMap<String, String> queryParameters,	CriteriaBuilder criteriaBuilder, Root<MessageClassification> root) 
	{
