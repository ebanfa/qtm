...
import com.nathanclaire.alantra.base.rest.request.ProductFeatureTypeRequest;
...
@Stateless
public class ProductFeatureTypeService extends BaseEntityService<ProductFeatureType> 
{
	/**
	 * @param entityClass
	 */
