 ...
 */
@Stateless
public class TxnConfirmationStatusServiceImpl 
	extends BaseEntityServiceImpl<TxnConfirmationStatus, TxnConfirmationStatusResponse, TxnConfirmationStatusRequest> 
	implements TxnConfirmationStatusService
{

	private static final String ENTITY_NAME = "TxnConfirmationStatus";
	private static final String LIST_ACTIVITY_CODE = "LIST_TRANSACTION_TXNCONFIRMATIONSTATUS";
	private static final String EDIT_ACTIVITY_CODE = "EDIT_TRANSACTION_TXNCONFIRMATIONSTATUS";
	
	private Logger logger = LoggerFactory.getLogger(TxnConfirmationStatusServiceImpl.class);
	 ...
	 * @param entityClass
	 */
	public TxnConfirmationStatusServiceImpl() {
		super(TxnConfirmationStatus.class);
	}

    /* (non-Javadoc)
	 * @see com.nathanclaire.alantra.txnConfirmationStatus.service.TxnConfirmationStatus#findById(java.lang.Integer)
	 */
	@Override
	public TxnConfirmationStatus findById(Integer id) throws ApplicationException {
		return getSingleInstance(id);
	}

	/* (non-Javadoc)
	 * @see com.nathanclaire.alantra.txnConfirmationStatus.service.TxnConfirmationStatus#findByCode(java.lang.String)
	 */
	@Override
	public TxnConfirmationStatus findByCode(String code) throws ApplicationException {
		return findInstanceByCode(code);
	}

	/* (non-Javadoc)
	 * @see com.nathanclaire.alantra.transaction.service.TxnConfirmationStatus#findByName(java.lang.String)
	 */
	@Override
	public TxnConfirmationStatus findByName(String name) throws ApplicationException {
		return findInstanceByName(name);
	}

	/* (non-Javadoc)
	 * @see com.nathanclaire.alantra.transaction.service.TxnConfirmationStatus#findAll(java.util.Map)
	 */
	@Override
	public List<TxnConfirmationStatus> findAll(MultivaluedMap<String, String> queryParameters) throws ApplicationException {
		return findAllInstances(queryParameters);
	}

	/* (non-Javadoc)
	 * @see com.nathanclaire.alantra.transaction.service.TxnConfirmationStatus#createTxnConfirmationStatus(com.nathanclaire.alantra.transaction.rest.request.ServiceRequest)
	 */
	@Override
	public TxnConfirmationStatus create(TxnConfirmationStatusRequest txnConfirmationStatusRequest) throws ApplicationException {
		return createInstance(txnConfirmationStatusRequest);
	}

	/* (non-Javadoc)
	 * @see com.nathanclaire.alantra.transaction.service.TxnConfirmationStatus#deleteTxnConfirmationStatus(java.lang.Integer)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see com.nathanclaire.alantra.transaction.service.TxnConfirmationStatus#updateTxnConfirmationStatus(com.nathanclaire.alantra.txnConfirmationStatus.rest.request.ServiceRequest)
	 */
	@Override
	public TxnConfirmationStatus update(TxnConfirmationStatusRequest txnConfirmationStatusRequest) throws ApplicationException {
		return updateInstance(txnConfirmationStatusRequest);
	}
	...
	public List<ListItemResponse> asListItem() throws ApplicationException {
		...
		for(TxnConfirmationStatus txnConfirmationStatus: findAll(queryParameters))
		{
			ListItemResponse item = new ListItemResponse(txnConfirmationStatus.getId(), txnConfirmationStatus.getCode(), txnConfirmationStatus.getName());
			listItems.add(item);
		}
		return listItems;
	}
     ...
     */
	@Override
    public TxnConfirmationStatus convertRequestToModel(TxnConfirmationStatusRequest txnConfirmationStatusRequest) 
     throws ApplicationException {
	...
	@Override
	public TxnConfirmationStatusResponse convertModelToResponse(TxnConfirmationStatus model) throws ApplicationException {
	 ...
	 * @param chequeNo
	 * @param currencyId
	 * @param txnConfirmationStatusTypeId
	 * @param amount
	 */
	...
	protected Predicate[] extractPredicates(
			MultivaluedMap<String, String> queryParameters,	CriteriaBuilder criteriaBuilder, Root<TxnConfirmationStatus> root) 
	{
