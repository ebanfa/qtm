...
public class ServiceTransactionStatusRESTService extends BaseActivityRESTService<ServiceTransactionStatusResponse, ServiceTransactionStatusRequest> 
{
	...
	/* (non-Javadoc)
	 * @see com.nathanclaire.alantra.base.rest.BaseActivityRESTService#populateListActivityResponse(com.nathanclaire.alantra.transaction.response.ServiceTransactionStatusResponse, com.nathanclaire.alantra.base.response.ListActivityResponse, javax.ws.rs.core.MultivaluedMap)
	 */
	@Override
