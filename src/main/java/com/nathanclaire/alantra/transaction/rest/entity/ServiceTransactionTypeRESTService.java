...
public class ServiceTransactionTypeRESTService extends BaseActivityRESTService<ServiceTransactionTypeResponse, ServiceTransactionTypeRequest> 
{
	...
	/* (non-Javadoc)
	 * @see com.nathanclaire.alantra.base.rest.BaseActivityRESTService#populateListActivityResponse(com.nathanclaire.alantra.transaction.response.ServiceTransactionTypeResponse, com.nathanclaire.alantra.base.response.ListActivityResponse, javax.ws.rs.core.MultivaluedMap)
	 */
	@Override
