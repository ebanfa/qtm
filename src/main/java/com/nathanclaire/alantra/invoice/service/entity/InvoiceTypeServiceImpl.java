...
import com.nathanclaire.alantra.invoice.request.InvoiceTypeRequest;
...
public class InvoiceTypeServiceImpl extends BaseEntityServiceImpl<InvoiceType, InvoiceTypeRequest> implements InvoiceTypeService
{
	 ...
	 */
	@Override
	public InvoiceType create(InvoiceTypeRequest invoiceTypeRequest) {
		return createInstance(invoiceTypeRequest);
	}
	 ...
	 */
	@Override
	public InvoiceType update(InvoiceTypeRequest invoiceTypeRequest) {
