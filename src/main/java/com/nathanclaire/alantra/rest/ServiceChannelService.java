...
import com.nathanclaire.alantra.model.businessdata.ServiceChannel;
import com.nathanclaire.alantra.rest.request.ServiceChannelRequest;
...
@Path("/servicechannel")
@Stateless
public class ServiceChannelService extends BaseEntityService<ServiceChannel> 
{
	/**
	 * @param entityClass
	 */
