...
import com.nathanclaire.alantra.model.product.ProductFeatureApplicabilityType;
...
@Stateless
public class ProductFeatureApplicabilityTypeService extends BaseEntityService<ProductFeatureApplicabilityType> 
{
	/**
	 * @param entityClass
	 */
